...
//
//	mockgen -source=transformer.go -destination=../../mocks/transformer.go -package=mocks -mock_names=Transformer=MockTransformer
//
...
func (mr *MockTransformerMockRecorder) Transform(ctx, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
