...
//
//	mockgen -source=clock.go -destination=../mocks/clock.go -package=mocks -mock_names=Clock=MockClock
//
...
func (mr *MockClockMockRecorder) Unix(sec, nsec any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
