...
//
//	mockgen -source=ethclient.go -destination=../mocks/ethclient.go -package=mocks -mock_names=EthClientDialer=MockEthClientDialer
//
...
func (mr *MockEthClientMockRecorder) CodeAt(ctx, account, blockNumber any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEthClientMockRecorder) TransactionSender(ctx, tx, block, index any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEthClientDialerMockRecorder) Dial(ctx, rawurl any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
