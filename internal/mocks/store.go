...
//
//	mockgen -source=internal/store/store.go -destination=internal/mocks/store.go -package=mocks -mock_names=Store=MockStore
//
...
// AppendScanLogsAdvanceCursor mocks base method.
func (m *MockStore) AppendScanLogsAdvanceCursor(ctx context.Context, sessionID int64, logs []schema.AddressScanLog, newCursor uint64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AppendScanLogsAdvanceCursor", ctx, sessionID, logs, newCursor)
	ret0, _ := ret[0].(error)
	return ret0
}

// AppendScanLogsAdvanceCursor indicates an expected call of AppendScanLogsAdvanceCursor.
func (mr *MockStoreMockRecorder) AppendScanLogsAdvanceCursor(ctx, sessionID, logs, newCursor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AppendScanLogsAdvanceCursor", reflect.TypeOf((*MockStore)(nil).AppendScanLogsAdvanceCursor), ctx, sessionID, logs, newCursor)
}
...
// CreateAddressScanSession mocks base method.
func (m *MockStore) CreateAddressScanSession(ctx context.Context, chain domain.Chain, address string, fromBlock, toBlock uint64) (*schema.AddressScanSession, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateAddressScanSession", ctx, chain, address, fromBlock, toBlock)
	ret0, _ := ret[0].(*schema.AddressScanSession)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateAddressScanSession indicates an expected call of CreateAddressScanSession.
func (mr *MockStoreMockRecorder) CreateAddressScanSession(ctx, chain, address, fromBlock, toBlock any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateAddressScanSession", reflect.TypeOf((*MockStore)(nil).CreateAddressScanSession), ctx, chain, address, fromBlock, toBlock)
}
...
func (m *MockStore) DeleteAddressScanSession(ctx context.Context, sessionID int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAddressScanSession", ctx, sessionID)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteAddressScanSession indicates an expected call of DeleteAddressScanSession.
func (mr *MockStoreMockRecorder) DeleteAddressScanSession(ctx, sessionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAddressScanSession", reflect.TypeOf((*MockStore)(nil).DeleteAddressScanSession), ctx, sessionID)
}
...
// FinishAddressScanReplay mocks base method.
func (m *MockStore) FinishAddressScanReplay(ctx context.Context, sessionID int64, tokens []schema.AddressScanToken) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FinishAddressScanReplay", ctx, sessionID, tokens)
	ret0, _ := ret[0].(error)
	return ret0
}

// FinishAddressScanReplay indicates an expected call of FinishAddressScanReplay.
func (mr *MockStoreMockRecorder) FinishAddressScanReplay(ctx, sessionID, tokens any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FinishAddressScanReplay", reflect.TypeOf((*MockStore)(nil).FinishAddressScanReplay), ctx, sessionID, tokens)
}
...
// GetAddressScanLogs mocks base method.
func (m *MockStore) GetAddressScanLogs(ctx context.Context, sessionID int64) ([]schema.AddressScanLog, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAddressScanLogs", ctx, sessionID)
	ret0, _ := ret[0].([]schema.AddressScanLog)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAddressScanLogs indicates an expected call of GetAddressScanLogs.
func (mr *MockStoreMockRecorder) GetAddressScanLogs(ctx, sessionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAddressScanLogs", reflect.TypeOf((*MockStore)(nil).GetAddressScanLogs), ctx, sessionID)
}

// GetAddressScanSession mocks base method.
func (m *MockStore) GetAddressScanSession(ctx context.Context, chain domain.Chain, address string) (*schema.AddressScanSession, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAddressScanSession", ctx, chain, address)
	ret0, _ := ret[0].(*schema.AddressScanSession)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAddressScanSession indicates an expected call of GetAddressScanSession.
func (mr *MockStoreMockRecorder) GetAddressScanSession(ctx, chain, address any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAddressScanSession", reflect.TypeOf((*MockStore)(nil).GetAddressScanSession), ctx, chain, address)
}
...
// GetPendingAddressScanTokens mocks base method.
func (m *MockStore) GetPendingAddressScanTokens(ctx context.Context, sessionID int64) ([]schema.AddressScanToken, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPendingAddressScanTokens", ctx, sessionID)
	ret0, _ := ret[0].([]schema.AddressScanToken)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetPendingAddressScanTokens indicates an expected call of GetPendingAddressScanTokens.
func (mr *MockStoreMockRecorder) GetPendingAddressScanTokens(ctx, sessionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPendingAddressScanTokens", reflect.TypeOf((*MockStore)(nil).GetPendingAddressScanTokens), ctx, sessionID)
}
...
// MarkAddressScanTokensIndexed mocks base method.
func (m *MockStore) MarkAddressScanTokensIndexed(ctx context.Context, sessionID int64, tokenCIDs []domain.TokenCID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MarkAddressScanTokensIndexed", ctx, sessionID, tokenCIDs)
	ret0, _ := ret[0].(error)
	return ret0
}

// MarkAddressScanTokensIndexed indicates an expected call of MarkAddressScanTokensIndexed.
func (mr *MockStoreMockRecorder) MarkAddressScanTokensIndexed(ctx, sessionID, tokenCIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkAddressScanTokensIndexed", reflect.TypeOf((*MockStore)(nil).MarkAddressScanTokensIndexed), ctx, sessionID, tokenCIDs)
}
...
func (m *MockStore) UpdateTokenMediaHealthByURL(ctx context.Context, url string, update store.MediaHealthUpdate) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateTokenMediaHealthByURL", ctx, url, update)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateTokenMediaHealthByURL indicates an expected call of UpdateTokenMediaHealthByURL.
func (mr *MockStoreMockRecorder) UpdateTokenMediaHealthByURL(ctx, url, update any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTokenMediaHealthByURL", reflect.TypeOf((*MockStore)(nil).UpdateTokenMediaHealthByURL), ctx, url, update)
}
