...
//
//	mockgen -source=sweeper.go -destination=../mocks/sweeper.go -package=mocks -mock_names=Sweeper=MockSweeper
//
...
func (mr *MockSweeperMockRecorder) Start(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
