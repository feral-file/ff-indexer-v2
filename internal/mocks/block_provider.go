...
//
//	mockgen -source=block.go -destination=../mocks/block_provider.go -package=mocks -mock_names=BlockFetcher=MockBlockFetcher
//
...
func (mr *MockBlockProviderMockRecorder) GetBlockTimestamp(ctx, blockNumber any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBlockProviderMockRecorder) GetLatestBlock(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBlockFetcherMockRecorder) FetchBlockTimestamp(ctx, blockNumber any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBlockFetcherMockRecorder) FetchLatestBlock(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
