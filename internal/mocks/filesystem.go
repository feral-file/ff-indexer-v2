...
//
//	mockgen -source=filesystem.go -destination=../mocks/filesystem.go -package=mocks -mock_names=FileSystem=MockFileSystem
//
...
func (mr *MockFileSystemMockRecorder) Close(file any) *gomock.Call {
...
func (mr *MockFileSystemMockRecorder) ReadFile(filePath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileSystemMockRecorder) WriteFile(file, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
