...
// Source: internal/workflows/core_executor.go
//
// Generated by this command:
//
//	mockgen -source=internal/workflows/core_executor.go -destination=internal/mocks/core_executor.go -package=mocks -mock_names=CoreExecutor=MockCoreExecutor
//
