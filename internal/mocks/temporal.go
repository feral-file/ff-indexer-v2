...
//
//	mockgen -source=temporal.go -destination=../mocks/temporal.go -package=mocks -mock_names=Activity=MockActivity
//
...
func (mr *MockWorkflowMockRecorder) GetCurrentHistoryLength(ctx any) *gomock.Call {
...
func (mr *MockWorkflowMockRecorder) GetExecutionID(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkflowMockRecorder) GetParentWorkflowID(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkflowMockRecorder) GetRunID(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockActivityMockRecorder) GetInfo(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
