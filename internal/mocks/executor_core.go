...
//
//	mockgen -source=core_executor.go -destination=../mocks/executor_core.go -package=mocks -mock_names=CoreExecutor=MockCoreExecutor
//
...
func (mr *MockCoreExecutorMockRecorder) GetEthereumTokenCIDsByOwnerWithinBlockRange(ctx, address, requestedFromBlock, requestedToBlock, limit, order any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
