...
//
//	mockgen -source=provider.go -destination=../../mocks/media_provider.go -package=mocks -mock_names=Provider=MockMediaProvider
//
...
func (m *MockMediaProvider) UploadImageFromReader(ctx context.Context, reader io.Reader, filename, contentType string, metadata map[string]any) (*mediaprovider.UploadResult, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMediaProviderMockRecorder) UploadImageFromReader(ctx, reader, filename, contentType, metadata any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMediaProvider) UploadImageFromURL(ctx context.Context, sourceURL string, metadata map[string]any) (*mediaprovider.UploadResult, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMediaProviderMockRecorder) UploadImageFromURL(ctx, sourceURL, metadata any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMediaProvider) UploadVideo(ctx context.Context, sourceURL string, metadata map[string]any) (*mediaprovider.UploadResult, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMediaProviderMockRecorder) UploadVideo(ctx, sourceURL, metadata any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
