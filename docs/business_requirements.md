...
- **Workflow-backed operations** — **Temporal**-tracked triggers and status for long-running work; chain ingestion starts workflows directly inside the indexing process.
...
- **Operational sustainability** — Stack choices in the README (PostgreSQL, Temporal, workers) support **scaling and recovery**; health and workflow surfaces support operators and integrators.
