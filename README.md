...
- **[Address scan sessions](docs/address_scan_sessions.md)** - Checkpointed Ethereum owner discovery: window-major scan, staged logs, persisted token list, quota-paced indexing
